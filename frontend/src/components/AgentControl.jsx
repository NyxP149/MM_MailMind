      ...
      <div className="agent-columns">
        <section className="agent-panel agent-policy">
          ...
          <div className="agent-policy-body">
            ...
            {liveMode && <label className="agent-arm"><input type="checkbox" checked={armed} disabled={running} onChange={(event) => setArmed(event.target.checked)} /><span>J’autorise ce lot à ajouter uniquement le libellé réversible MailMind/À supprimer, sans archiver ni supprimer.</span></label>}
